...
std::vector<glm::mat4> PointLight::CalculateLightTransform()
{
	...
	// Positive Y
	lightMatrices.push_back(lightProj 
		* glm::lookAt(Position, Position + glm::vec3(0.0, 1.0, 0.0), glm::vec3(0.0f, 0.0f, 1.0)));
	// Negative Y
	lightMatrices.push_back(lightProj 
		* glm::lookAt(Position, Position + glm::vec3(0.0, -1.0, 0.0), glm::vec3(0.0f, 0.0f, -1.0)));
	// Positive Z
	lightMatrices.push_back(lightProj 
		* glm::lookAt(Position, Position + glm::vec3(0.0, 0.0, 1.0), glm::vec3(0.0f, -1.0f, 0.0)));
	// Negative Z
	lightMatrices.push_back(lightProj 
		* glm::lookAt(Position, Position + glm::vec3(0.0, 0.0, -1.0), glm::vec3(0.0f, -1.0f, 0.0)));

//	glm::mat4 testMat = lightProj 
//		* glm::lookAt(Position, Position + glm::vec3(1.0, 0.0, 0.0), glm::vec3(0.0f, -1.0f, 0.0));
